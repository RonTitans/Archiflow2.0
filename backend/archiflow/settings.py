...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'archiflow'),
        'USER': os.environ.get('DATABASE_USER', 'archiflow'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'archiflow_secure_pass_2024'),
